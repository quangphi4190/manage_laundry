...
@section('content-header')
    <h1>
        {{ trans('qlythuebaocuakhach::qlythuebaocuakhaches.title.create qlythuebaocuakhach') }}
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('qlythuebaocuakhach::qlythuebaocuakhaches.title.create qlythuebaocuakhach') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.qlythuebaocuakhach.qlythuebaocuakhach.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('qlythuebaocuakhach::admin.qlythuebaocuakhaches.partials.create-fields', ['lang' => $locale])
                        </div>
                    @endforeach
